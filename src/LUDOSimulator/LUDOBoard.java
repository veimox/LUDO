 ...
 * the course of AI01 - tools of artificial intelligence.
 *  
...
public class LUDOBoard extends Canvas
{
    ...
    //Carlos variable
    public double[][] Qtable = new double[7][9];
	...
	setSize(1000,800);
	try {
	    boardImage = ImageIO.read(new File("res/ludoboard.jpg"));
	    redBrickImage1 = ImageIO.read(new File("res/redbrick.jpg"));
	    redBrickImage2 = ImageIO.read(new File("res/redbrick2.jpg"));
	    redBrickImage3 = ImageIO.read(new File("res/redbrick3.jpg"));
	    redBrickImage4 = ImageIO.read(new File("res/redbrick4.jpg"));

	    blueBrickImage1 = ImageIO.read(new File("res/bluebrick.jpg"));
	    blueBrickImage2 = ImageIO.read(new File("res/bluebrick2.jpg"));
	    blueBrickImage3 = ImageIO.read(new File("res/bluebrick3.jpg"));
	    blueBrickImage4 = ImageIO.read(new File("res/bluebrick4.jpg"));

	    yellowBrickImage1 = ImageIO.read(new File("res/yellowbrick.jpg"));
	    yellowBrickImage2 = ImageIO.read(new File("res/yellowbrick2.jpg"));
	    yellowBrickImage3 = ImageIO.read(new File("res/yellowbrick3.jpg"));
	    yellowBrickImage4 = ImageIO.read(new File("res/yellowbrick4.jpg"));

	    greenBrickImage1 = ImageIO.read(new File("res/greenbrick.jpg"));
	    greenBrickImage2 = ImageIO.read(new File("res/greenbrick2.jpg"));
	    greenBrickImage3 = ImageIO.read(new File("res/greenbrick3.jpg"));
	    greenBrickImage4 = ImageIO.read(new File("res/greenbrick4.jpg"));

	    dice1Image = ImageIO.read(new File("res/dice1.jpg"));
	    dice2Image = ImageIO.read(new File("res/dice2.jpg"));
	    dice3Image = ImageIO.read(new File("res/dice3.jpg"));
	    dice4Image = ImageIO.read(new File("res/dice4.jpg"));
	    dice5Image = ImageIO.read(new File("res/dice5.jpg"));
	    dice6Image = ImageIO.read(new File("res/dice6.jpg"));
	    noDiceImage = ImageIO.read(new File("res/no_dice.jpg"));
	} catch (IOException e) {
	    e.printStackTrace();
	    System.exit(0);
	}
    ...
    private float waitTime = 10/steps; 
	...
	else if(!(index<=endFieldSquares[color]&&(index + dice2)>endFieldSquares[color])&&index<100) /*Moving on the field*/ 
	{
	    ...
	    if(index==((1+color)*100+9)) {
		return new_bricks_state; //Unable to move the selected brick... illegal move already home
	    }
	    if(index<51) { /*still on the field*/
		new_bricks_state[color][nr] = (index + dice2)-(1+endFieldSquares[color])+((1+color)*100+4);
	    }
	    else {
		//If we got a dice bigger than home, bounce
		if((index + dice2)>((1+color)*100+9)) {
		    new_bricks_state[color][nr]=2*((1+color)*100+9)-(index + dice2);
		}
		//Else, just move
